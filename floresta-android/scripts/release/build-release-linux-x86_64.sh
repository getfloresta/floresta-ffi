...
mkdir -p ../floresta-android/lib/src/main/jniLibs/$RESOURCE_DIR_ARMEABI_V7A/
...
cp ./target/$COMPILATION_TARGET_ARMEABI_V7A/release-smaller/$LIB_NAME ../floresta-android/lib/src/main/jniLibs/$RESOURCE_DIR_ARMEABI_V7A/
